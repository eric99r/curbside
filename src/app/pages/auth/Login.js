...
import{LOGINRSERVERESPONSE} from "../../serverErrorconstant/serverError.constant";
        ...
        <div className="kt-login__form">
          <div className="kt-login__title">
            ...
            <div className="kt-form">
              <FormattedMessage id="AUTH.LOGIN.INSTRUCTION" />              
              </div>
          </div>
              ...
              setTimeout(() => {
                login(values.email, values.password)
                  ...
                  .catch((error) => {
                    disableLoading();
                    setSubmitting(false);
                    if(error.response.data===LOGINRSERVERESPONSE.LOCKED)
                    {
                      setStatus(
                        intl.formatMessage({
                          id: "AUTH.LOGIN.LOCKED"
                        })
                      );
